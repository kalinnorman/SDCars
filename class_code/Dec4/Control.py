...
class Control:
    ...
    def update_sensors(self, yolo_flag=False):
        ...
        :return:
        """
        coordinates = self.sensor.update_sensors(yolo_flag=yolo_flag)
        return coordinates
    ...
    def _initialize_car(self, start, pid_flag=False):
        """
        ...
        self._send_command("!start"+start+"\n")
        self.drive(0.0)
